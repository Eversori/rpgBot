...
public class CmdRollDiceTwenty implements Command, Diced
{
	...
	public void singleRoll(GuildMessageReceivedEvent e, String name, Random rn)
	{
		...
		writer.writeInfo(":game_die: " + name + " rolls a 20 sided dice and gets a " + x);
	...
	public void multiRoll(GuildMessageReceivedEvent e, String name, Random rn, String cStr)
	{
		...
		writer.writeInfo(":game_die: " + name + " rolls a 20 sided dice " + count + " times and gets " + x);
		e.getMessage().delete().queue();
